...
//this is alternate way to do line no. 78//
// we will asign the above variable to a new variable button id//
// button_id = clicked_msg;
// likes_value = document.getElementById(button_id).value;